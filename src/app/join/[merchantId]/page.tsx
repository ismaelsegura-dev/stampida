    ...
    >
      <div className="max-w-md w-full bg-white rounded-lg p-8 shadow-2xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">{merchant.nombre}</h1>
        ...
        <form id="customer-form" className="space-y-4">
          <div>
            ...
            <input
              ...
              name="nombre"
              required
              className="w-full px-4 py-2 border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:border-gray-900"
            />
          </div>
        ...
        <div id="wallet-buttons" className="hidden mt-6 space-y-3">
          <button
            id="apple-wallet-btn"
            className="w-full py-3 bg-black text-white rounded-lg font-semibold hover:bg-gray-800 transition flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="w-full py-3 bg-white text-gray-900 border-2 border-gray-900 rounded-lg font-semibold hover:bg-gray-50 transition flex items-center justify-center gap-2"
          >
